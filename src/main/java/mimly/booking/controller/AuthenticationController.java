...
public class AuthenticationController {
    ...
    public ResponseEntity<AuthenticationDTO> isAuthenticated(HttpSession httpSession, Principal principal) {
        httpSession.setMaxInactiveInterval(principal != null
                ? DEFAULT_INACTIVE_INTERVAL_IN_SECONDS
                : MAX_INACTIVE_INTERVAL_IN_SECONDS
        );
        return new ResponseEntity<>(AuthenticationDTO.builder()
                .assistant(principal != null ? principal.getName() : null)
